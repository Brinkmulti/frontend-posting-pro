...
function brink_fp_dashboard_search_where($where, $query) {
    ...
    if (ctype_digit($term)) {
        $conditions[] = $wpdb->prepare("{$wpdb->posts}.ID LIKE %s", $like);
    }
...
function brink_render_dashboard_tab() {
    ...
    <form method="get">
        ...
        <input type="text" name="search_ads" class="brink-search-bar" placeholder="Zoek in advertenties (titel, naam, e-mail, ID)..." value="<?php echo esc_attr($search_ads); ?>">
    ...
    <form method="get">
        ...
        <input type="text" name="search_erv" class="brink-search-bar" placeholder="Zoek in ervaringen (titel, naam, e-mail, ID)..." value="<?php echo esc_attr($search_erv); ?>">
        <button type="submit" class="button">Zoeken</button>
